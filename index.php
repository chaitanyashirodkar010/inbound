<?php get_header(); ?>
        ...
        <section class="ic-bnr-sec ic-sec-pad">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <h1 class="ic-font-weight-600 ic-color-black mb-3">Grow your Sales and Visibility with our
                            expertise</h1>
                        <h5>We help you rank high on google so more customers find your services and help your business
                            grow.</h5>
                ...
                <div id="owl-demo-2" class="owl-carousel owl-theme">
                    <div class="item">
                        <article class="mb-5 mb-md-auto">
                            <div class="md-img-zoom"><img
                                    src="<?php echo get_bloginfo('template_directory')?>/images/case-1.jpg"
                                    class="img-fluid" alt="Case Image"></div>
                            ...
                            <h3 class="line-height-inherit"><a href="case_study_Yourmechanic.html"
                                    class="ic-color-black d-flex"><span class="mr-1 fs-24">1530 %</span> <span
                                        class="fs-20">Y/Y increase in Non-Brand SEO Traffic</span></a></h3>
                    ...
                    <div class="item">
                        <article class="mb-5 mb-md-auto">
                            <div class="md-img-zoom"><img
                                    src="<?php echo get_bloginfo('template_directory')?>/images/case-2.jpg"
                                    class="img-fluid" alt="Case Image"></div>
                    ...
                    <div class="item">
                        <article>
                            <div class="md-img-zoom"><img
                                    src="<?php echo get_bloginfo('template_directory')?>/images/case-3.jpg"
                                    class="img-fluid" alt="Case Image"></div>
        ...
        <footer>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 align-logo"> <a class="navbar-brand"
                            href="https://www.ideacatalyst.net/index.html"><img src="./images/Logo.png"
