...
<section class="ic-bnr-sec ic-sec-pad mangeseo mb-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="ic-font-weight-600 ic-color-black mb-2 text-center">LET'S TALK GROWTH</h1>
                <h5 class="mb-2 text-center">We’ll show you the roadmap for more organic traffic and sales.</h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="leftsidetalk">
                        ...
                        <div class="talkicon">
                            <i class="fas fa-video"></i> <span>Web conferencing details provided upon
                                confirmation</span>
                        </div>


                        <p class="mt-3">Grab a time slot and lets chat </p>
                    </div>
                </div>
                <div class="col-lg-6">

                    <h5 class="ic-font-weight-600">Select a Date & Time</h5>
                </div>
            </div>
        </div>
    </div>
...
<section class="ic-bnr-sec ic-sec-pad mangeseo pb-0">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="ic-font-weight-600 ic-color-black mb-2 text-center">WHAT WE’LL DISCUSS</h1>
                <h5 class=" ic-color-black mb-5 text-center">What to expect during our consultation.</h5>
            ...
            <div class="col-md-4 bor-left">
                <div class="whatwe">
                    ...
                    <p>An overall review to assess your website’s current performance.</p>
            ...
            <div class="col-md-4 bor-left">
                <div class="whatwe">
                    ...
                    <p>“Low hanging fruit” that you can attack right away for results</p>
            ...
            <div class="col-md-4 bor-left">
                <div class="whatwe">
                    ...
                    <p>A realistic scope of how long it will take to meet your goals. </p>
